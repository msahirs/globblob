export const INFO_TEXT = `This is a simulation of the <a href="https://en.wikipedia.org/wiki/Physarum_polycephalum">Physarum polycephalum</a>, a slime mold that, even though itâ€™s missing a nervous system,
